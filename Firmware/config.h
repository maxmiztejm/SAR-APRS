...
// - Home:       0
// - IGate:      5
#define S_CALLSIGN      "AZERTY" //put your callsign
#define S_CALLSIGN_ID   6

// Destination callsign: APRS (with SSID=0) is usually okay.
#define D_CALLSIGN      "APRS"
#define D_CALLSIGN_ID   6
...
// it is to noise. 
#define APRS_COMMENT    "comment and message ..."
...
#define APRS_PERIOD   60    // seconds // send every one minute
